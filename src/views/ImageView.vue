<template>
  ...
  <div
    class="fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex items-center justify-center px-4"
    @click.self="closePopup"
  >
    <!-- Glowing Animated Lights -->
    <div class="absolute inset-0 pointer-events-none">
      <div v-for="n in 15" :key="n"
        class="absolute rounded-full opacity-20 blur-2xl"
        :style="{
    ...
    >
      ...
      <div class="grid lg:grid-cols-2 h-full">
        <!-- Image Column -->
        <div class="relative h-64 lg:h-[500px]">
          <img
          ...
          />
          <!-- Fancy Overlay Text -->
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-transparent to-transparent px-6 py-4">

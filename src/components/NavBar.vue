<template>
  <div class="fixed top-0 z-50 w-full">
    ...
    <div
      class="absolute top-[-10px] left-[-30px] w-[110px] h-fit z-60 cursor-pointer group"
      @click="toggleMenu"
    ...
    <div
      ...
      :class="{ 'panel-extend': showMenu, 'panel-retract': !showMenu }"
      @mouseenter="onHoverIn"
      @mouseleave="onHoverOut"
    >
      ...
      <router-link @click="onHoverOut" to="/contact_me">
    ...
    >
      <div class="ml-auto mr-[15px] gap-3 flex">
        <button class="bg-gradient-to-r from-amber-600 to-amber-800 hover:from-amber-700 hover:to-amber-900 text-amber-100 shadow-lg hover:shadow-amber-800/50 group">
          <span class="group-hover:scale-110 transition-transform">Get in Touch</span>
        </button>
